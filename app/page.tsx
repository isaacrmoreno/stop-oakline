...
export default function Home() {
  return (
    <main className='relative flex-1 overflow-hidden bg-[var(--page-bg)] text-[var(--ink)]'>
      ...
      <div className='relative mx-auto flex min-h-full w-full max-w-6xl flex-col gap-8 px-4 py-6 sm:gap-12 sm:px-10 sm:py-10 lg:flex-row lg:items-center lg:gap-16 lg:px-12 lg:py-16'>
        <section className='flex w-full max-w-2xl flex-col justify-center gap-4 sm:gap-6'>
          ...
          <div className='space-y-4'>
            <h1 className='max-w-xl text-4xl font-semibold leading-none tracking-[-0.04em] text-balance sm:text-6xl'>
              Find your Salem City Council representative.
            </h1>
          </div>

          <p className='max-w-lg text-sm leading-6 text-[color:rgba(29,37,35,0.72)] sm:leading-7'>
